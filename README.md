# Preface
This is a overall directory for all my computer graphics, my raytracing assignments are currently located in the startercode folder
...
```
Go to the location you want to the folder in your terminal
Type or paste: git clone https://github.com/ZBramblett/computer-graphics
...
```
This project uses vcpkg and have cmake presets
